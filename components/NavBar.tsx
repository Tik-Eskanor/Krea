    ...
    <section className='mt-2'>
      <div className='flex justify-between items-center'>
        ...
        <div className='hidden md:flex gap-3 items-center'>
          <Link href="" className='bg-secondary px-2 py-1 text-sm rounded-lg flex gap-1 font-medium items-center'><RiImageAiFill size={21} /> Gallery</Link>
          <Link href="" className='bg-secondary px-2 py-1 text-sm rounded-lg flex gap-1 font-medium items-center'><BiSupport size={21} /> Support</Link>
          <span className='bg-secondary p-[7px] rounded-full cursor-pointer'><FaBell size={14} /></span>
          <DarkModeSwitch />
          <div className="w-6 h-6 rounded-full bg-gradient-to-tr from-blue-400 to-blue-500 "></div>
        </div>
      </div>
