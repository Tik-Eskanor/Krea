            ...
            <table className='w-[100%] max-w-[100%]'>
              <thead className='bg-gray-50 dm-sans-500 text-[#4F5144] text-left'>
                <tr>
                  ...
                  <th className='font-semibold py-[10px] pl-6'>Created At</th>
                  <th className='font-semibold py-[10px] pl-6'>Updated At</th>
              ...
              <tbody className='text-[#4F5144]'>
                {data?.map((item) => (
                  <tr className="hover:bg-gray-50 border-b border-gray-200" key={item._id}>
                    ...
                    <td className='dm-sans-400 text-sm py-4 pl-6'>{formatDate(item.createdAt)}</td>
                    <td className='dm-sans-400 text-sm py-4 pl-6'>{formatDate(item.updatedAt)}</td>
